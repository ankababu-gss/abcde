...
}).AddUserStore<UserStore<ApplicationUser, ApplicationRole, DataContext, Guid, ApplicationUserClaim, ApplicationUserRole, ApplicationUserLogin, ApplicationUserToken, ApplicationRoleClaim>>()
   .AddRoleStore<RoleStore<ApplicationRole, DataContext, Guid, ApplicationUserRole, ApplicationRoleClaim>>();
//.AddEntityFrameworkStores<DataContext>();
