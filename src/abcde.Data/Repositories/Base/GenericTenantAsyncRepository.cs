...
namespace abcde.Data.Repositories.Base
{
...

    {
        ...
        protected GenericTenantAsyncRepository(DataContext context)
        {
        ...
        protected GenericTenantAsyncRepository(DataContext context, IDbContextFactory<DataContext> contextFactory)
        {
            UpdateDatabase(context);
            DataContext = context;
            Context = context;
